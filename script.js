...
const knowledgeData = {
  ...
  6: [
    { title: "不合理高薪與模糊職缺內容", content: "若職缺敘述含糊、工作內容未載明，卻開出異常高薪，通常是詐騙或非法仲介常用手法。\n警訊：「日薪 4000」、「不限學歷，工作超簡單」等。" },
    { title: "先付款、先購買的陷阱", content: "要求「押金、教材費、設備費、制服費」等，都是詐騙常見前兆。\n警訊：合法工作不會要求求職者先匯款或購買物品。" },
    { title: "要求提供個人證件或銀行帳戶", content: "詐騙常以「薪水入帳」、「資料驗證」為名要求身分證、提款卡、銀行帳號，後續可能涉及洗錢。\n警訊：雇主無權代保管個人證件。" },
    { title: "不正常的面試流程", content: "例如深夜通知、地點偏僻、臨時換地點、無公司名稱或招牌等。\n警訊：環境過於隱密、受訪者無明確身份。" },
    { title: "查證來源與公司合法性", content: "透過 Google 評價、公司登記資料、官方網站、電話、社群等進行交叉查證。\n防護措施：一定要確認「公司是否存在」。" },
    { title: "保留所有求職過程紀錄", content: "包含工作說明、對話截圖、薪資談判內容、對方身分資訊等。\n防護措施：必要時做為警示或申訴依據。" },
    { title: "永遠不要先匯款與購買商品", content: "詐騙常以「錄取前必須購買設備」為由進行誘導。\n防護措施：拒絕任何形式的事前支付。" },
    { title: "面試需告知親友並保持聯繫", content: "面試地點、時間、公司名稱應讓家人知道。\n防護措施：避免落入誘導至偏僻地點的陷阱。" },
    { title: "主動查證職缺資訊的三步驟", content: "步驟 1：查公司資訊（地址、統編、網站、評價）\n步驟 2：查工作是否合法（薪資是否合規、是否屬非法仲介）\n步驟 3：查對方身分是否一致（面試者是否為公司人員）" },
    { title: "任何理由的「先付款」都必須拒絕", content: "詐騙會包裝為：押金、保證金、機器費、教材費、訓練費。\n原則：「只要要你付錢，那就是有問題。」" },
    { title: "識別可疑訊號，學會先停下來", content: "例如工作條件突然更動、對方催促決定、不願說明薪資結構等。\n做法：遇到不明確資訊，應停止、查證後再決定。" }
  ]
};
