...
const knowledgeData = {
  ...
  3: [
    ...
    { title: "「三要七不」防詐騙口訣", content: " 三要""要查證雇主資訊：上網查評價、Google 地址、查看是否為合法登記公司。""要保持與家人朋友聯繫：讓可信任的人知道面試地點、時間、內容。""要保留求職過程證據：如工作說明、對話截圖、薪資條件等。" },
    { title: "「三要七不」防詐騙口訣", content: "七不\n不繳費、不轉帳：不支付任何名義的費用。""不購買公司指定商品或裝備：制服、教材等若強制購買多為詐騙。""不交出個人證件：身分證、提款卡、印章等不可交付他人保存。""不夜間單獨面試：尤其是青少年，應避免深夜陌生地點。""不簽署不明文件：合約內容若模糊或沒時間閱讀，應拒絕簽署。""不提供銀行帳戶資料：若要求提供帳戶供款項轉手，可能涉及詐騙洗錢。""不接受異常高額獎金的職務：常是誘使上當的陷阱。" },
  ...
  4: [
    ...
    { title: "年齡歧視", content: "主題說明：""以年齡多寡作為錄取與否或排班安排依據。" },
    { title: "性別歧視", content: "主題說明：""因求職者或員工的性別影響錄取、升遷或薪資。" },
    { title: "容貌與身材歧視", content: 
      "主題說明："
      "以外貌、膚色、身高、刺青、身材等作為錄取或工作分配的標準。" },
    { title: "種族或國籍歧視", content:
      "主題說明："
      "因學生的種族、膚色、語言、國籍而拒錄或給予較差待遇。" },
    { title: "宗教歧視", content:
      "主題說明："
      "因宗教信仰而排班不當、強迫佩戴物品、禁止穿著宗教服飾。" },
    { title: "工會身分歧視", content:
      "主題說明："
      "因加入工會、參與活動而遭排擠、威脅或減班。" }
  ],
  5: [
    { title: "蒐集證據與案件說明", content: "申訴人需先整理相關資訊，例如對話紀錄、工作證明、拒錄原因、歧視言論、職場處遇差別等，作為後續調查依據。" },
    { title: "流程步驟（六大階段）", content: 
      "以下六個主題對應臺北市政府勞動局處理歧視案件的實際流程脈絡。"
      "收件 → 審查 → 事實調查 → 召開評議委員會 → 做成審定書 → 行政處分。" },
    { title: "諮詢服務與後續追蹤", content:
      "勞動局會提供："
  ...
  6: [
    { title: "不合理高薪與模糊職缺內容", content:
      "若職缺敘述含糊、工作內容未載明，卻開出異常高薪，通常是詐騙或非法仲介常用手法。"
      "警訊：「日薪 4000」、「不限學歷，工作超簡單」等。" },
    { title: "先付款、先購買的陷阱", content: 
      "要求「押金、教材費、設備費、制服費」等，都是詐騙常見前兆。"
      "警訊：合法工作不會要求求職者先匯款或購買物品。" },
    { title: "要求提供個人證件或銀行帳戶", content:
      "詐騙常以「薪水入帳」、「資料驗證」為名要求身分證、提款卡、銀行帳號，後續可能涉及洗錢。"
      "警訊：雇主無權代保管個人證件。" },
    { title: "不正常的面試流程", content:
      "例如深夜通知、地點偏僻、臨時換地點、無公司名稱或招牌等。"
      "警訊：環境過於隱密、受訪者無明確身份。" },
    { title: "查證來源與公司合法性", content: 
      "透過 Google 評價、公司登記資料、官方網站、電話、社群等進行交叉查證。"
      "防護措施：一定要確認「公司是否存在」。" },
    { title: "保留所有求職過程紀錄", content:
      "包含工作說明、對話截圖、薪資談判內容、對方身分資訊等。"
      "防護措施：必要時做為警示或申訴依據。" },
    { title: "永遠不要先匯款與購買商品", content: 
      "詐騙常以「錄取前必須購買設備」為由進行誘導。"
      "防護措施：拒絕任何形式的事前支付。" },
    { title: "面試需告知親友並保持聯繫", content:
      "面試地點、時間、公司名稱應讓家人知道。"
      "防護措施：避免落入誘導至偏僻地點的陷阱。" },
    { title: "主動查證職缺資訊的三步驟", content: 
      "步驟 1：查公司資訊（地址、統編、網站、評價）"
      "步驟 2：查工作是否合法（薪資是否合規、是否屬非法仲介）"
      "步驟 3：查對方身分是否一致（面試者是否為公司人員）" },
    { title: "任何理由的「先付款」都必須拒絕", content:
      "詐騙會包裝為：押金、保證金、機器費、教材費、訓練費。"
      "原則：「只要要你付錢，那就是有問題。」" },
    { title: "識別可疑訊號，學會先停下來", content:
      "例如工作條件突然更動、對方催促決定、不願說明薪資結構等。"
